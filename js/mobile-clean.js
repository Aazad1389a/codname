...
const STYLE_ID = "codname-mobile-touch-scroll-v4";
...
#screen-menu.is-active,#screen-lobby.is-active,#screen-game.is-active,#screen-result.is-active{position:relative!important;overflow-x:hidden!important;overflow-y:auto!important;-webkit-overflow-scrolling:touch!important;touch-action:pan-y!important;}
...
#screen-menu .side-nav{position:fixed!important;left:0!important;right:auto!important;top:0!important;bottom:0!important;width:94px!important;height:100dvh!important;z-index:50!important;display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:space-between!important;box-sizing:border-box!important;padding:18px 10px!important;}
...
#screen-menu .menu-main{margin-left:94px!important;width:calc(100% - 94px)!important;min-width:0!important;height:auto!important;min-height:100%!important;display:block!important;overflow:visible!important;box-sizing:border-box!important;touch-action:pan-y!important;}
...
@media(max-width:700px){
  /* Explicit touch-scroll container for the complete menu content. */
  ...
  /* Let the scrollable parent, not nested wrappers, receive the finger gesture. */
  #screen-menu .menu-main{
    margin-left:78px!important;
    width:calc(100% - 78px)!important;
    height:auto!important;min-height:calc(100dvh + 1px)!important;
    padding:0 0 36px!important;
    overflow:visible!important;
    touch-action:pan-y!important;
  }
  #screen-menu .menu-main>.topbar{height:58px!important;min-height:58px!important;padding:0 10px!important;}
  #screen-menu .menu-main>.reference-layout{width:100%!important;height:auto!important;min-height:max-content!important;padding:0 10px 60px!important;box-sizing:border-box!important;}
  ...
  #screen-menu .reference-hero{min-height:0!important;height:auto!important;margin:0 0 12px!important;}
