...
// The pool is intentionally larger than any single board to increase replay variety.
...
if (WORD_CARDS.length !== 1500) {
    throw new Error(`CODNAME card pool must contain exactly 1500 cards; got ${WORD_CARDS.length}.`);
}
