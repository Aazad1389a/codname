...
// Replace this only with the project's publishable key. Never put a secret/service_role key here.
export const SUPABASE_PUBLISHABLE_KEY = "REPLACE_WITH_YOUR_PUBLISHABLE_KEY";

let client = null;

export function getSupabase() {
    if (!client && SUPABASE_PUBLISHABLE_KEY && !SUPABASE_PUBLISHABLE_KEY.startsWith("REPLACE_")) {
