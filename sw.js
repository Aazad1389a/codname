const CACHE = 'codname-shell-v8';
const ASSETS = [
  './', './index.html', './css/style.css', './css/menu-reference.css', './css/effects.css',
  './js/main.js', './js/ui.js', './js/ui-fixes.js', './js/install-entry.js', './js/github-auth-ui.js', './js/auth.js', './js/game.js', './js/cards.js', './js/multiplayer.js', './js/player.js', './js/supabase.js',
