const CACHE = 'codname-shell-v16';
const ASSETS = [
  './', './index.html', './404.html', './css/style.css', './css/menu-reference.css', './css/effects.css', './css/menu-visuals.css',
  './js/main.js', './js/pre.js', './js/ios-fix.js', './js/ui.js', './js/ui-fixes.js', './js/install-entry.js', './js/github-auth-ui.js', './js/menu-visuals.js', './js/mobile-clean.js', './js/workspace.js', './js/workspace-v2.js', './js/clue-system.js', './js/auth.js', './js/game.js', './js/cards.js', './js/multiplayer.js', './js/player.js', './js/supabase.js',
